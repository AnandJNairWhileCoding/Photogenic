...
class _MainPageState extends State<MainPage> {
  ...
  // int cont.currentPageIndex.toInt() = 0;
  APIController cont = Get.put(APIController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: cont.currentPageIndex.toInt() == 0 
      ? AppBar(
        elevation: 0.0,
        centerTitle: true,
        ...
        children: [
          Obx(
            () => PageView(
              ...
              onPageChanged: (value) {
                setState(() => cont.currentPageIndex = RxInt(value));
              },
              children: [
                // Screen One
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            IconButton(color: cont.currentPageIndex.toInt() == 0 ? null : Colors.grey[500], onPressed: () => _pageController.jumpToPage(0), splashColor: Colors.transparent, highlightColor: Colors.transparent, icon: Icon(Icons.home_rounded, size: 30)),
            IconButton(color: cont.currentPageIndex.toInt() == 1 ? null : Colors.grey[500], onPressed: () => _pageController.jumpToPage(1), splashColor: Colors.transparent, highlightColor: Colors.transparent, icon: Icon(Icons.search),iconSize: 30),
            ...
            IconButton(color: cont.currentPageIndex.toInt() == 2 ? null : Colors.grey[500], onPressed: () => _pageController.jumpToPage(2), splashColor: Colors.transparent, highlightColor: Colors.transparent, icon: Icon(FontAwesomeIcons.bell)),
            IconButton(
              color: cont.currentPageIndex.toInt() == 3 ? null : Colors.grey[500], onPressed: () {
    ...
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            color: cont.currentPageIndex.toInt() == pageIndex ? null : Colors.grey[500]),
          cont.currentPageIndex.toInt() == pageIndex ? SizedBox(height: 0.0) : Text("Home")
        ],
      ),
    );
  }
